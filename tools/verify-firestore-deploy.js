// tools/verify-firestore-deploy.js
// Usage: node verify-firestore-deploy.js <admin-email>
// Requirements:
// - Node 18+ (for fetch), or install node-fetch and adjust the script
...
async function main() {
  ...
  if (!email) {
    console.error('Usage: node verify-firestore-deploy.js <admin-email>');
    process.exit(2);
  }
  ...
  try {
    ...
    console.log('Custom claim set. Note: the user should sign out/sign back in to refresh tokens.');
